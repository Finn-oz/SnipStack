...
export const TAURI_COMMAND = {
  ...
  LIST_OCR_LANGUAGE_PACKS: "list_ocr_language_packs",
  ...
  SNIP_CANCEL: "snip_cancel",
  SNIP_CONFIRM: "snip_confirm",
  SNIP_OVERLAY_READY: "snip_overlay_ready",
